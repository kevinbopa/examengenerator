...
### Story 1 - Architecture documentee

En tant que developpeur,
je veux une vue claire de l'architecture actuelle,
afin de faire evoluer le projet sans casser les flux existants.

Critere d'acceptation :
- un document de synthese presente le frontend, le backend et les flux IA;
...
je veux des tests sur les routes et la logique critique,
afin de reduire les regressions.
...
En tant qu'etudiant,
je veux une aide linguistique discrete et fiable,
afin d'ameliorer la forme de ma reponse sans perturber mon examen.

Critere d'acceptation :
- les suggestions se repositionnent correctement;
...
En tant qu'etudiant,
je veux recuperer une copie corrigee claire,
afin de comprendre ce qui doit etre ameliore.
...
je veux des prompts explicites et structures,
afin d'obtenir des sorties plus coherentes et plus auditables.

Critere d'acceptation :
- les objectifs de generation sont formalises;
